...
var DateTimePickerDays = (function (_Component) {
  ...
  function DateTimePickerDays() {
    ...
    this.renderDays = function () {
      ...
      while (prevMonth.isBefore(nextMonth)) {
        ...
        if (_this.props.dayOverrides.length > 0) {
          dayOverride = _this.props.dayOverrides.find(function (override) {
            return (0, _moment2["default"])(override.date).isSame(prevMonth);
          });
  ...
  _createClass(DateTimePickerDays, [{
    ...
    value: {
      ...
      dayOverrides: _react.PropTypes.array,
